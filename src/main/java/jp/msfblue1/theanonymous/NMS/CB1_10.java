 ...
 */
public class CB1_10 implements NMSAdapter {
    @Override
    public void setName(Player p) {
        ...
        //Class<? extends EntityHuman> epc = eh.getClass();
        try {
            //Field gameprofile = EntityHuman.class.getDeclaredField("bT");
            //ReflectionUtil.setFieldAccessible(gameprofile);

            setObjectFINALPRVATE(eh,"bT",gp);
