 ...
 */
public class CB1_9 implements NMSAdapter {
    ...
    public void setName(Player p) {
        ...
        try {
            //Field gameprofile = EntityHuman.class.getDeclaredField("bR");
            //ReflectionUtil.setFieldAccessible(gameprofile);
            //Object oldgameprofile = ReflectionUtil.getObject(eh,"bR");

            setObjectFINALPRVATE(eh,"bR",gp);
            //ReflectionUtil.setObject(oldgameprofile,"bR",gp);
    ...
    private void updateSkin(Player player){
        ...
        try{
            ...
            PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(dimension,difficulty,worldtype, WorldSettings.EnumGamemode.getById(gmid));
